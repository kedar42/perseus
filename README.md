...
```sh
bun add https://github.com/kedar42/perseus/releases/download/v0.2.1/kedar42-perseus-0.2.1.tgz
```
...
Run the checks above, then `bun pm pack --ignore-scripts --filename /tmp/kedar42-perseus-0.2.1.tgz` after building. Publish the archive as an asset of the matching GitHub version tag. Consumers pin a release URL and the archive integrity in their lockfile. Do not replace assets of published versions; release a new version for changes.
